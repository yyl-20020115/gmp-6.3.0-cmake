...
set(CMAKE_ASM_YASM_SOURCE_FILE_EXTENSIONS yasm nasm asm)
...
if(NOT CMAKE_ASM_YASM_COMPILE_OBJECT)
  set(CMAKE_ASM_YASM_COMPILE_OBJECT "<CMAKE_ASM_YASM_COMPILER> <DEFINES> <INCLUDES> <FLAGS> -f ${CMAKE_ASM_YASM_OBJECT_FORMAT} -o <OBJECT> <SOURCE>")
endif()

if(CMAKE_ASM_YASM_COMPILER_ID STREQUAL "YASM")
  set(CMAKE_DEPFILE_FLAGS_ASM_YASM "-MD <DEP_FILE> -MT <DEP_TARGET>")

  if((NOT DEFINED CMAKE_DEPENDS_USE_COMPILER OR CMAKE_DEPENDS_USE_COMPILER)
      AND CMAKE_GENERATOR MATCHES "Makefiles|WMake")
    # dependencies are computed by the compiler itself
    set(CMAKE_ASM_YASM_DEPFILE_FORMAT gcc)
    set(CMAKE_ASM_YASM_DEPENDS_USE_COMPILER TRUE)
  endif()
endif()
